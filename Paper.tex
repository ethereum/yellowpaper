...
\hyperlink{I__v}{I_{\mathrm{v}}} & \equiv & e \\
I_{\mathrm{w}} & \equiv & w
\end{eqnarray}
...
\item\linkdest{exec_permission_to_modify_state_I__w}{}\linkdest{I__e} $I_{\mathrm{w}}$, the permission to make modifications to the state.
\end{itemize}
