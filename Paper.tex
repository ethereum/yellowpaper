...
For a list of terms used in this paper, refer to \ref{ch:Terminology}.
...
0x00 & {\small STOP} & 0 & 0 & This operation halts execution, see \label{STOP} and \label{emptySequence} for further information. \\
\midrule
