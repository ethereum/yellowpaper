...
$G_{sha3}$ & 20 & Paid for a {\small Keccak} operation. \\
...
G_{sha3} & \text{if} \quad w = \text{\small Keccak}\\
...
\begin{tabular*}{\columnwidth}[h]{rlrrl}
\toprule
\multicolumn{5}{c}{\textbf{20s: Keccak}} \vspace{5pt} \\
\textbf{Value} & \textbf{Mnemonic} & $\delta$ & $\alpha$ & \textbf{Description} \vspace{5pt} \\
0x20 & {\small Keccak} & 2 & 1 & Compute Keccak-256 hash. \\
