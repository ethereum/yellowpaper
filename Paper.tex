...
\nonumber {} & + \begin{cases} \hyperlink{G__txcreate}{G_{\mathrm{txcreate}}} + \hyperlink{initcode_cost}{N({\lVert T_{\mathbf{i}} \rVert})} & \text{if} \quad T_{\mathrm{t}} = \varnothing \\ 0 & \text{otherwise} \end{cases} \\
...
\hypertarget{initcode_cost}{}We define the \textit{initcode cost function}, formally $N$, as the amount of gas that needs to be paid for each word of the initcode prior to executing the creation code of a new contract:

\begin{equation}
  N(x) \equiv \hyperlink{G__initcodeword}{G_{\mathrm{initcodeword}}} \times \lceil \frac{x}{32} \rceil
\end{equation}
...
\begin{eqnarray}
P(\boldsymbol{\sigma}_w, W) & \equiv & \boldsymbol{\sigma}_{w+1} \\
...
\begin{equation}
K(\boldsymbol{\sigma}, B) \equiv P(P(\boldsymbol{\sigma}, W_0), W_1) ...
\end{equation}
...
G_{\mathrm{create}} + \hyperlink{initcode_cost}{N(\boldsymbol{\mu}_{\mathbf{s}}[2])} & \text{if} \quad w = \text{\small CREATE}\\
G_{\mathrm{create}}+G_{\mathrm{keccak256word}} \times \lceil \boldsymbol{\mu}_{\mathbf{s}}[2] \div 32 \rceil + \hyperlink{initcode_cost}{N(\boldsymbol{\mu}_{\mathbf{s}}[2])} & \text{if} \quad w = \text{\small \hyperlink{create2}{CREATE2}}\\
