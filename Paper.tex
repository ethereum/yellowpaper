...
\begin{equation}
(\boldsymbol{\sigma}', g') \equiv \Lambda(\boldsymbol{\sigma}, s, o, g, p, v, \mathbf{i})
\end{equation}
...
If such an exception does not occur, then the remaining gas is refunded to the originator and the now-altered state is allowed to persevere. Thus formally, we may specify the resultant state and gas as $(\boldsymbol{\sigma}', g')$ where:
\begin{equation}
...
\begin{equation}
(\boldsymbol{\sigma}', g', \mathbf{o}) \equiv \Theta(\boldsymbol{\sigma}, s, o, r, g, p, v, \mathbf{d})
\end{equation}
...
&&&& $(\boldsymbol{\sigma}', \boldsymbol{\mu}'_g) \equiv \begin{cases}\Lambda(\boldsymbol{\sigma}^*, I_a, I_o, \boldsymbol{\mu}_g, I_p, \boldsymbol{\mu}_\mathbf{s}[0], \mathbf{i}) & \text{when} \quad \boldsymbol{\mu}_\mathbf{s}[0] \leqslant \boldsymbol{\sigma}[I_a]_b \\ (\boldsymbol{\sigma}, \boldsymbol{\mu}_g) & \text{otherwise} \end{cases}$ \\
