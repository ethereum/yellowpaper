...
Occasionally actors cannot agree on a protocol change.
For instance, in 2016 a fraction of the Ethereum community disagreed with the DAO bailout, which led to an alternative blockchain dubbed "Ethereum Classic".
In order to distinguish between different blockchains, EIP-155 by \cite{EIP-155} introduced the concept of chain ID, which we denote by $\beta$.
