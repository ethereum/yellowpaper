...
Let $F_{p^2}$ be a field $F_{\mathrm{p}}[i]/(i^2+1)$. We define a set $C_2$ with
\begin{equation}
...
& \multicolumn{4}{l}{$\boldsymbol{\mu}_{\mathbf{s}}[x]_{\mathrm{i}}$ gives the $i$th bit (counting from zero) of $\boldsymbol{\mu}_{\mathbf{s}}[x]$} \vspace{5pt}  \\
\midrule
0x1b & {\small SHL} & 2 & 1 & Bitwise shifting to the left. \\
&&&& $\boldsymbol{\mu}'_{\mathbf{s}}[0] \equiv 2 ^ {\boldsymbol{\mu}_{\mathbf{s}}[0]} \times \boldsymbol{\mu}_{\mathbf{s}}[1].$ \\
\midrule
0x1c & {\small SHR} & 2 & 1 & Bitwise logical shifting to the right. \\
&&&& $\boldsymbol{\mu}'_{\mathbf{s}}[0] \equiv \left\lfloor \dfrac{ \boldsymbol{\mu}_{\mathbf{s}}[1]}{ 2 ^ {\boldsymbol{\mu}_{\mathbf{s}}[0]} } \right\rfloor$
\\
\midrule
0x1d & {\small SAR} & 2 & 1 & Bitwise arithmetic shifting to the right. \\
&&&& $\boldsymbol{\mu}'_{\mathbf{s}}[0] \equiv \left\lfloor \dfrac{ \boldsymbol{\mu}_{\mathbf{s}}[1]}{ 2 ^ {\boldsymbol{\mu}_{\mathbf{s}}[0]} } \right\rfloor$ \\
& \multicolumn{4}{l}{where $\boldsymbol{\mu}_{\mathbf{s}}[1]$ is treated as two's complement signed 256-bit integer.}  \\
\midrule
\end{tabu}
