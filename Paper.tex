...
$G_{sreset}$ & 5000 & Paid for an {\small SSTORE} operation when the storage value's zeroness remains unchanged. \\
$R_{sclear}$ & 15000 & Refund given (added into refund counter) when the storage value is set to zero from non-zero. \\
$G_{create}$ & 32000 & Paid for a {\small CREATE} operation. \\
$G_{createdata}$ & 200 & Paid per byte for a {\small CREATE} operation to succeed in placing code into state. \\
