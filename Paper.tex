...
\title[イーサリアム: A Secure Decentralised Generalised Transaction Ledger\\ \smaller \textbf{{Berlin version}}]{Ethereum: A Secure Decentralised Generalised Transaction Ledger \\ \smaller \textbf{{Berlin version \YellowPaperVersionNumber}}}
\author{
    Dr. Gavin Wood\\
