...
%
%\begin{itemize}
%\item {\small KECCAK} costs $G_{keccak}$ gas
...
$G_{keccak}$ & 30 & Paid for each {\small KECCAK} operation. \\
$G_{keccakword}$ & 6 & Paid for each word (rounded up) for input data to a {\small KECCAK} operation. \\
...
G_{keccak}+G_{keccakword} \lceil \mathbf{s}[1] \div 32 \rceil & \text{if} \quad w = \text{\small KECCAK}\\
