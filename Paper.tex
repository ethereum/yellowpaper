...
\begin{eqnarray}
\quad v(x) & \equiv & x_n \in \mathbb{P} \wedge x_p \in \mathbb{P} \wedge (x_r = x_c = \varnothing \vee w(x)) \\
\quad w(x) & \equiv & x_r \in \mathbb{B}_{32} \quad \wedge \quad x_c \in \mathbb{B}_{32}
\end{eqnarray}
