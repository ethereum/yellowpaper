...
\begin{equation}
 d_{size} = E_{prime}(\hyperlink{Jdatasetinit}{J_{\mathrm{datasetinit}}} + \hyperlink{Jdatasetgrowth}{J_{\mathrm{datasetgrowth}}} \cdot E_{\mathrm{epoch}} - \hyperlink{Jmixbytes}{J_{\mathrm{mixbytes}}}, J_{\mathrm{mixbytes}})
\end{equation}
The size of the cache, $c_{size}$, is calculated using
\begin{equation}
 c_{size} = E_{prime}(\hyperlink{Jcacheinit}{J_{\mathrm{cacheinit}}} + \hyperlink{Jcachegrowth}{J_{\mathrm{cachegrowth}}} \cdot E_{\mathrm{epoch}} - \hyperlink{Jhashbytes}{J_{\mathrm{hashbytes}}}, J_{\mathrm{hashbytes}})
\end{equation}
\begin{equation}
