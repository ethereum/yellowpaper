...
&&&& $\boldsymbol{\mu}'_\mathbf{s}[0] \equiv \mathbf{o}'[0..31]$ \\
...
In the block XXX, before any transaction is executed, the account state under address 240 is modified so that it contains code:
\begin{verbatim}
