...
\begin{equation}
\lVert B_\mathbf{U} \rVert \leqslant 2 \bigwedge_mathbf{U} \in B_\mathbf{U}} V(U) \; \wedge \; k(U, P(B_H)_H, 6)
\end{equation}
...
\qquad\forall_mathbf{U} \in B_\mathbf{U}}: \\ \nonumber
...
\begin{equation}
\forall_mathbf{I} \in \mathfrak{I}} I \equiv (I_0, I_1)
\end{equation}
...
\texttt{\small RLP}\Big( \big(\texttt{\small HP}(I_0[i .. (j - 1)], false), n(\mathfrak{I}, j) \big) \Big) & \text{if} \quad i \ne j \quad \text{where} \; j = \arg \max_x : \exists \mathbf{l}: \lVert \mathbf{l} \rVert = x : \forall_mathbf{I} \in \mathfrak{I}}: I_0[0 .. (x - 1)] = \mathbf{l} \\
