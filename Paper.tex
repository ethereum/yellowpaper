...
The given \textbf{gasUsed} must correspond faithfully to the transactions listed: \hyperlink{H__g}{${B_H}_{\mathrm{g}}$}, the total gas used in the block, must be equal to the accumulated gas used according to the final transaction:
\begin{equation}
\hyperlink{H g}{${B_H}_{\mathrm{g}}$} = \hyperlink{ell}{\ell}\hyperlink{R__u}{(\mathbf{R})_{\mathrm{u}}}
\end{equation}
