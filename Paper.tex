...
\begin{equation}
\text{Let} \quad R_b = 1.5^{16}
\end{equation}

\subsubsection{State \& Nonce Validation}
...
B'_n & = & n: \quad \mathcal{P}(B^*, n) < \frac{2^{256}}{H_d} \\
...
Thus the complete block-transition mechanism, less $\mathcal{P}$, the proof-of-work function is defined.
...
Throw out nodes in state that haven't sent/received a transaction in over X blocks.
