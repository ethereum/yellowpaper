...
%Uncomment out after merging \hypertargets for v, r, and s.
%Thus: 
...
We may then define the sender function $S$ of the transaction as:\hypertarget{T w}{}\hypertarget{T r}{}\hypertarget{T s}{}
\begin{eqnarray}
