...
\qquad\boldsymbol{\sigma}'[{\mathbf{B}_{H}}_{\mathrm{c}}]_{\mathrm{b}} \!\!& = &\!\! \boldsymbol{\sigma}[{\mathbf{B}_{H}}_{\mathrm{c}}]_{\mathrm{b}} + R_{\mathrm{block}} + \lVert\mathbf{B}_{\mathbf{U}}\rVert \left\lfloor\frac{R_{\mathrm{block}}}{32}\right\rfloor \\
\\ \nonumber
...
R & \equiv & \left\lfloor\frac{(8 + U_{\mathrm{i}} - {B_{H}}_{\mathrm{i}}) R_{\mathrm{block}}}{8}\right\rfloor
\end{eqnarray}
