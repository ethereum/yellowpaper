...
\author{
    Dr. Gavin Wood\\
    Founder, Ethereum \& Parity (formerly Ethcore)\\
    i@gavwood.com\footnote{Please talk to maintainers on Github such as @pirapira and @nicksavers, only contact Gavin with their permission.}
}
\begin{document}
