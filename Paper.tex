...
&&&& This has the effect of writing said value to $\boldsymbol{\mu}_{pc}$. See section \ref{ch:model}. \\
\midrule
0x58 & {\small PC} & 0 & 1 & Get the value of the program counter \textit{before} it's incremented by this instruction. \\
...
\midrule
0x5a & {\small GAS} & 0 & 1 & Get the amount of available gas, taking into account the cost of this instruction. \\
