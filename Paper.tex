...
\end{equation}
where $v$ is the account validity function:\hypertarget{account validity function v x}{account validity function v x}
\begin{equation}
...
\item[gasPrice] A scalar value equal to the number of Wei to be paid per unit of \textit{gas} for all computation costs incurred as a result of the execution of this transaction; formally $T_p$.\hypertarget{tx_gas_limit_T__g}{tx gas limit T g}
