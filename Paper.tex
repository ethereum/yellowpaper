...
\begin{equation}
(\boldsymbol{\sigma}', g', A, \mathbf{o}) \equiv \Theta(\boldsymbol{\sigma}, s, o, r, g, p, v, \mathbf{d}, e)
\end{equation}
...
\forall_{U \in B_\mathbf{U}} \; \boldsymbol{\sigma}'[U_b]_b & = & \boldsymbol{\sigma}[U_b]_b + \frac{15}{16}R_b
\end{eqnarray}
