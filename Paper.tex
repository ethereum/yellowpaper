...
\end{equation}
with $(n, m) = \mathtt{PoW}(H_{\hcancel{n}}, H_n, \mathbf{d})$.\hypertarget{block_header_without_nonce_and_mixmash_h__cancel_n}{}
...
\end{equation}\hypertarget{self_destruct_set_wordy_defn}{}
...
\subsection{Execution}\hypertarget{intrinsic_gas_g_0}{}
...
\boldsymbol{\sigma}[S(T)] & \neq & \varnothing \quad \wedge \hypertarget{transaction_nonce}{}\\
