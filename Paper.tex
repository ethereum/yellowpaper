...
%( w = \{ \text{\small JUMPI} \quad \wedge \boldsymbol{\mu}_\mathbf{s}[1] = 0 \quad \wedge \quad \boldsymbol{\mu}_\mathbf{pc} +1 > \lVert I_\mathbf{b} \rVert ) ) \quad \vee \\
...
( w = \text{\small JUMP} \quad \wedge \quad \boldsymbol{\mu}_\mathbf{s}[0] \notin D(I_\mathbf{b}) ) \quad \vee \nonumber \\
( w = \text{\small JUMPI} \quad \wedge \quad \boldsymbol{\mu}_\mathbf{s}[1] \neq 0 \quad \wedge \quad \boldsymbol{\mu}_\mathbf{s}[0] \notin D(I_\mathbf{b}) ) \quad \vee \nonumber \\
( w =  \text{\small JUMPI} \quad \wedge \quad  \boldsymbol{\mu}_\mathbf{s}[1] = 0 \quad \wedge \quad \boldsymbol{\mu}_\mathbf{pc} +1 > \lVert I_\mathbf{b} \rVert ) \quad \vee \nonumber \\
