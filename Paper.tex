...
This bilinear map is a type three pairing. The ZK-Snark verification contract takes a set of points $a_i$ that are in $G_1$, and a set of points $b_i$ that are in $G_2$. It checks that
\begin{equation}
