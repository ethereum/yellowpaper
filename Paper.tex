...
\boldsymbol{\mu}_g - C_{\text{\tiny CALLEXTRA}}(\boldsymbol{\sigma}, \boldsymbol{\mu}) & \text{if} \quad \boldsymbol{\mu}_g < C_{\text{\tiny CALLEXTRA}}(\boldsymbol{\sigma}, \boldsymbol{\mu}) + \boldsymbol{\mu}_{\mathbf{s}}[0] \;\wedge \\
